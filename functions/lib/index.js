...
exports.deleteUseCase = exports.deleteEntity = exports.getMetricsPeriods = exports.saveMetrics = exports.updateUseCase = exports.updateEntity = exports.getUseCase = exports.getUseCases = exports.getEntity = exports.getEntities = void 0;
...
async function calculateEntityStats(entityId) {
    ...
    for (const doc of useCasesSnapshot.docs) {
        ...
        if (!metricsSnapshot.empty) {
            ...
            const dsMetric = metrics.general?.find((m) => m.label === 'Cantidad de DS');
            if (dsMetric?.value) {
...
exports.deleteEntity = functions.https.onRequest((req, res) => {
    corsHandler(req, res, async () => {
        ...
        try {
            ...
            // Delete entity
            batch.delete(db.collection('entities').doc(entityId));
            await batch.commit();
